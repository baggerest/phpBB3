...
$lang = array_merge($lang, array(
	...
	'HELP_BBCODE_QUOTES_CODE_ANSWER'	=> '如果您需要輸出一段固定寬度的代碼或其他任何東西，例如 Courier 字體，您必須將文字包含在 <strong>[code][/code]</strong> 標籤中，例如<br /><br /><strong>[code]</strong>echo "This is some code";<strong>[/code]</strong><br /><br />所有使用 <strong>[code][/code]</strong> 標籤包圍的文字格式將會以原來的形式顯示。PHP 高亮度語法可以使用 <strong>[code=php][/code]</strong>，當您發表 PHP 代碼文章時建議使用，以利於閱讀。',
