...
$lang = array_merge($lang, array(
	...
	<br />
	您的帳號的主要資訊為：一個獨特的識別名稱（以下以「您的會員名稱」代表），一個讓您登入到您的帳號的個人密碼（以下以「您的密碼」代表）以及一個有效的個人電子郵件位址（以下以「您的電子郵件」代表）。在「%1$s」中，您的帳號所包含的個人資料是由這個網站所在國家或地域的資料保護法所保護。除了您的會員名稱、您的密碼以及您的電子郵件以外，我們有權決定哪一些額外資訊是您必須或非必須提供給「%1$s」的。這些非必須的額外資訊，您有權決定哪一些資訊是可以對外公開的。除此之外，在您的帳號中，您可以選擇是否要接收來自 phpBB 軟體內部所寄發的電子信件。<br />
	<br />
	您的密碼已經（單向雜湊演算法）加密處理過，因此它是安全的。但是，我們建議您不要在多個網站重複使用相同的密碼。您的密碼是讓您在「%1$s」存取以及使用您的帳號的方法，所以，請您務必要小心保護它。此外，不論在何種情況下「%1$s」、phpBB 或是任何第三方公司的任何人都不會跟您索取您的密碼。如果您忘記了您的帳號的您的密碼，您可以使用 phpBB 軟體提供的「我忘記了自己的密碼」功能。這個程序將會要求您提供您的會員名稱以及您的電子郵件，之後 phpBB 軟體會幫您產生一組新的密碼以讓您繼續使用您的帳號。<br />
	',
));
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_COPPA'					=> '您的帳號被建立，但是需要管理員批准。請檢查您的電子郵件信箱以獲得詳細訊息。',
	'ACCOUNT_EMAIL_CHANGED'			=> '您的帳號資料已更新成功。然而您需要完成帳號啟用程序後才能登入討論區，系統已經將您的帳號啟用序號寄送到您的新電子郵件信箱，請檢查您的電子郵件信箱以取得相關的資訊。',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> '您的帳號資料已更新成功，然而這個討論區的會員資格必須獲得管理員的批准，會員帳號才會被啟用。管理員們已經接獲通知，當您的帳號被啟用後您會收到電子郵件通知。',
	'ACCOUNT_INACTIVE'				=> '您的帳號已被建立。然而您需要完成帳號啟用程序後才能登入討論區，系統已經將您的帳號啟用序號寄送到您的電子郵件信箱，請檢查您的電子郵件信箱以取得相關的資訊。',
	'ACCOUNT_INACTIVE_ADMIN'		=> '您的帳號已被建立，然而這個討論區的會員資格必須獲得管理員的批准，會員帳號才會被啟用。管理員們已經接獲通知，當您的帳號被啟用後您會收到電子郵件通知。',
	'ACTIVATION_EMAIL_SENT'			=> '系統已經將您的帳號啟用序號寄送到您的電子郵件信箱。',
	'ACTIVATION_EMAIL_SENT_ADMIN'	=> '帳號啟用的申請信已經寄送到管理員的電子郵件信箱。',
	'ADD'							=> '增加',
	'ADD_BCC'						=> '增加 [密件副本]',
	'ADD_FOES'						=> '增加黑名單',
	...
	'AVATAR_EXPLAIN_NO_FILESIZE'	=> '最大尺寸：寬度 %1$s、高度 %2$s。',
	...
	'COPPA_EXPLAIN'				=> '請注意，點選送出鍵後將會建立您的帳號，但是您的帳號需要父母或是監護人的同意才能啟用。您將會收到一封電子郵件，包含需要填寫的表格以及寄送方法。',
	'CREATE_FOLDER'				=> '增加資料夾...',
	'CURRENT_IMAGE'				=> '目前的圖片',
	'CURRENT_PASSWORD'			=> '目前的密碼',
	'CURRENT_PASSWORD_EXPLAIN'	=> '如果您要變更電子郵件位址或會員名稱，那麼您必須輸入您目前的密碼。',
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => '如果要變更密碼、電子郵件位址或會員名稱，那麼您必須輸入您目前的密碼。',
	...
	'DOMAIN_NO_MX_RECORD_EMAIL'	=> '您輸入的電子郵件無有效的 MX 記錄。',
	'DOWNLOADS'					=> '下載',
	...
	'EMAIL_BANNED_EMAIL'		=> '您輸入的電子郵件位址已被禁止使用。',
	'EMAIL_REMIND'				=> '您輸入的電子郵件位址必須能讓我們聯絡到您。如果您從未在會員控制台做過更動，那麼它就是您註冊時所提供的電子郵件位址。',
	'EMAIL_TAKEN_EMAIL'			=> '您輸入的電子郵件位址已經被他人使用。',
	...
	'NOTIFICATION_METHOD_EMAIL'							=> '電子郵件',
	...
	'NO_EMAIL_USER'				=> '無法找到符合的電子郵件之會員名稱。',
	'NO_FOES'					=> '黑名單是空的',
	'NO_FRIENDS'				=> '好友是空的',
	...
	'PASSWORD_UPDATED'			=> '一個新的密碼已經傳送到您註冊的電子郵件信箱。',
	...
	'UCP'						=> '會員控制台',
	'UCP_ACTIVATE'				=> '啟用帳號',
	'UCP_ADMIN_ACTIVATE'		=> '在帳號啟用前您必須輸入一個有效的電子郵件位址，管理員將審核您的帳號，如果審核通過，您將會收到寄往您提供的電子郵件信箱的啟用通知。',
	...
	'UCP_EMAIL_ACTIVATE'		=> '在帳號啟用前您必須輸入一個有效的電子郵件位址。您將會收到寄往您提供的電子郵件信箱的啟用通知與啟用連結。',
