...
$lang = array_merge($lang, array(
	...
	'PHP_VERSION_REQD_EXPLAIN'			=> 'phpBB 需要 PHP 版本 5.4.0 或更高。',
	...
	'PCRE_UTF_SUPPORT_EXPLAIN'			=> '如果您的 PHP 安裝沒有在 PCRE 擴充功能中使用 UTF-8 支持編譯，phpBB 將不會運行。',
	'PHP_JSON_SUPPORT'					=> 'PHP JSON 支持',
	'PHP_JSON_SUPPORT_EXPLAIN'			=> '為了使 phpBB 正常工作，PHP JSON 擴充功能需要可用的。',
	'PHP_XML_SUPPORT'					=> 'PHP XML/DOM 支持',
	'PHP_XML_SUPPORT_EXPLAIN'			=> 'I為了使 phpBB 正常工作，PHP XML/DOM 擴充功能需要可用的。',
	'PHP_SUPPORTED_DB'					=> '支持的資料庫',
	'PHP_SUPPORTED_DB_EXPLAIN'			=> '您必須支持至少一個在 PHP 中兼容的資料庫。如果沒有資料庫模組顯示為可用，您應該聯繫您的主機提供商，或查看相關的 PHP 安裝說明以獲取建議。',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> '這是在您安裝 phpBB3 後的一篇範例文章。似乎一切事情都可正常運作。如果您喜歡，那麼您可以刪除這篇文章以及繼續設定您的討論區。在安裝的過程中，您的第一個分區和第一個版面，被指派了一個適當的版面權限設定，其包含的預設會員群組有管理員、機器人、全域版主、訪客、註冊會員、以及註冊 COPPA 會員等。如果您也選擇要刪除您的第一個分區和第一個版面，那麼不要忘記指派版面權限到所有您新建的分區以及版面。當您要新建分區以及版面時，建議重新命名您的第一個分區和第一個版面，以及複製其版面權限。祝您使用愉快！',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>建議的方法是使用自動更新包來更新您的安裝。您也可以使用寫在 INSTALL.html 檔案的方法更新。自動更新的步驟是：</p>
...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> '您已經將您的討論區成功轉換為 phpBB 3.2，您現在可以登入以及<a href="../">使用您的討論區</a>。請在刪除「install」資料夾以啟用您的討論區前，確認所有的設定都已經被正確地轉換。請記得 phpBB 的線上使用說明位於 <a href="https://www.phpbb.com/support/docs/en/3.2/ug/">Documentation（使用說明文件）</a>和 <a href="https://www.phpbb.com/community/viewforum.php?f=466">support forums（技術支援版面）</a>。',
