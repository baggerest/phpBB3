...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_LOGIN_DELETE_COOKIES_ANSWER'	=> '「刪除所有討論區 Cookies」是指刪除所有在討論區所建立的 Cookies。這些 Cookies 保留您在討論區上的認證和登入狀態。如果它們已經被討論區管理員啟用，Cookies 還可以提供如讀出跟踪的功能。假如您有登入或登出討論區的問題，那麼刪除討論區 Cookies 或許是有幫助的。',
	'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'	=> '「刪除所有討論區 Cookies」是做什麼用？',
