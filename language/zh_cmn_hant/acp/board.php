...
$lang = array_merge($lang, array(
	...
	'ADMIN_EMAIL'					=> '返回電子郵件位址',
	'ADMIN_EMAIL_EXPLAIN'			=> '這將是所有的電子郵件之返回位址。在電子郵件中，它將用於 <samp>Return-Path</samp> 和 <samp>Sender</samp>。',
	...
	'EMAIL_FUNCTION_NAME'			=> '電子郵件函數名稱',
	'EMAIL_FUNCTION_NAME_EXPLAIN'	=> '透過 PHP 用於發送電子郵件的函數。',
	...
	'SMTP_SERVER_EXPLAIN'			=> '請注意，您必須提供您的伺服器使用的協議。如果您有使用 SSL，則必須是「ssl://your.mailserver.com」。',
