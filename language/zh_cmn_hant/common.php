...
$lang = array_merge($lang, array(
	...
	'ALL_MESSAGES'  => '所有訊息',
	'ALL_POSTS' => '所有文章',
	'ALL_TIMES' => '所有顯示的時間為 <span title="%2$s">%1$s</span>',
	'ALL_TOPICS'    => '所有主題',
	'ALT_TEXT'						=> '替代文字',
	'AND'   => '和',
	...
	'AVATAR_NO_TEMP_DIR'			=> '無法找到暫存資料夾或無法寫入。',
	...
	'AVATAR_PHP_UPLOAD_STOPPED'		=> 'PHP 擴充功能已停止檔案上傳。',
	...
	'BACK_TO_TOP'   => '回頂端',
	'BACK_TO_PREV'  => '回到前一頁',
	'BAN_TRIGGERED_BY_EMAIL'    => '您的電子郵件位址已經被封鎖。',
	...
	'COOKIE_CONSENT_MSG'	=> '本網站使用 Cookies 以確保您在我們網站獲得最佳體驗。',
	'COOKIE_CONSENT_OK'		=> '了解了！',
	...
	'EDIT_POST' => '編輯文章',
	'ELLIPSIS'							=>	'…',
	'EMAIL' => '電子郵件',// EMAIL_ADDRESS 的簡寫
	'EMAIL_ADDRESS' => '電子郵件位址',
	'EMAIL_INVALID_EMAIL'               => '您輸入的電子郵件位址是無效的。',
	'EMAIL_SMTP_ERROR_RESPONSE' => '發送電子郵件在 <strong>第 %1$s 行</strong> 遇到問題。回應訊息：%2$s。',
	...
	'FAQ'   => '問答集',
	'FAQ_EXPLAIN'   => '問答集',
	'FEATURE_NOT_AVAILABLE' => '所請求的功能在此討論區上不可用。',
	'FILENAME'  => '檔案名稱',
	'FILESIZE'  => '檔案大小',
	'FILEDATE'  => '檔案日期',
	'FILE_COMMENT'  => '檔案註釋',
	...
	'INVALID_EMAIL_LOG' => ' <strong>%s</strong> 可能是無效的電子郵件位址？',
	'INVALID_FEED_ATTACHMENTS'	=> '所選 feed 嘗試使用無效的限制提取附加檔案。',
	...
	'LOGIN_CONFIRM_EXPLAIN'            => '為了防止暴力破解會員帳號，討論區將會要求您在超過最大嘗試登入次數後輸入一組確認代碼，確認代碼顯示在如下所示的圖檔中。如果您有視覺相關問題因而無法瀏覽判斷時，請聯絡 %s討論區管理員%s。', // 不使用的
	...
	'NOTIFICATION_METHOD_INVALID'		=> '模式「%s」不能提交有效的通知方法。',
	...
	'NO_EMAIL_MESSAGE'  => '沒有電子郵件內容。',
	'NO_EMAIL_RESPONSE_CODE'    => '無法得到郵件伺服器回應碼。',
	'NO_EMAIL_SUBJECT'  => '沒有電子郵件主題。',
	'NO_FORUM'  => '您選擇的版面不存在。',
	...
	'NO_FEED_ENABLED'           => '在這個討論區的消息來源是不可用的。',
	...
	'SORRY_AUTH_READ_TOPIC'		=> '您沒有閱讀這個主題的權限。',
	'SORRY_AUTH_VIEW_ATTACH'    => '您沒有下載這個附加檔案的權限。',
	'SORT_BY'   => '排序',
	'SORT_DIRECTION'			=> '方向',
	'SORT_JOINED'   => '註冊時間',
	'SORT_LOCATION' => '來自',
	'SORT_OPTIONS'				=> '顯示和排序選項',
	'SORT_RANK' => '等級',
	'SORT_POSTS'                => '文章',
	'SORT_TOPIC_TITLE'  => '主題',
	'SORT_USERNAME' => '會員名稱',
	...
	'TOO_SHORT_EMAIL'   => '您輸入的電子郵件位址太短了。',
	'TOO_SHORT_EMAIL_CONFIRM'   => '您輸入的確認電子郵件位址太短了。',
	'TOO_SMALL'                     => '您輸入的值太小。',
	'TOO_SMALL_MAX_RECIPIENTS'      => '這個 <strong>每個私人訊息所允許的最大收件人數</strong> 設定，您輸入的值太小。',

	'TOPIC' => '主題',
	'TOPICS'    => '主題',
	'TOPICS_UNAPPROVED' => '在這討論區至少有一個主題沒有被核准。',
	'TOPIC_ICON'    => '主題圖示',
