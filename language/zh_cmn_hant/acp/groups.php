...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'	=> '這個設定會覆蓋會員的私人訊息數量限制。用戶的所有群組之最大值用於確定實際的值。<br />將此值設定為 0 以使用討論區設定覆蓋此組的所有用戶之設定。',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> '在每則私人訊息中，允許收件人的最大數量。用戶的所有群組之最大值用於確定實際的值。<br />將此值設定為 0 以使用討論區設定覆蓋此組的所有用戶之設定。',
	...
	'TEAMPAGE_FORUMS_EXPLAIN'	=> '如果設定為是，版主將有顯示其擁有版主權限的版面列表。對大型討論區而言，這是非常需要的資料庫。',
